...
/* ************************************************************** */
TEST(TestUntestedFactorial, OneIsGivenOneIsExpected)
{
    EXPECT_EQ(1, factorial_untested(1));
}

TEST(TestUntestedFactorial, TwoIsGivenTwoIsExpected)
{
    EXPECT_EQ(2, factorial_untested(2));
}

TEST(TestUntestedFactorial, FourIsGivenTwentyFourIsExpected)
{
    EXPECT_EQ(24, factorial_untested(4));
}

TEST(TestUntestedFactorial, ZeroIsGivenOneIsExpected)
{
    EXPECT_EQ(1, factorial_untested(0));
}